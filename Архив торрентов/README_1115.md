...
---------------------------------------------------------------------------------------------------------------
###  Публикация: 590112   (144655) от 16.12.2012

[Программа] (Windows PC) Samsung Kies 2.5.0.12114_1 [multi+rus]
...
Новая версия Samsung Kies с поддержкой Windows 8.
Samsung Kies - это программа, предназначенна для синхронизации работы мобильных устройств Samsung с компьютером. Обмен данными происходит по USB-интерфейсу или по беспроводному каналу — Wi-Fi
